...
<body>
    ...
    <div class="container-xxl bg-white p-0">
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 justify-items-center">
                        ...
                        <a href="{{ url('education') }}" class="nav-item nav-link {{ request()->is('education') ? 'active' : '' }}">Edukasi</a>
                        <a href="{{ url('/project') }}" class="nav-item nav-link {{ request()->is('project') ? 'active' : '' }}">Project</a>
                    </div>
                    <!-- Tambahkan tombol logout -->
                    <form action="{{ route('logout') }}" method="POST" class="d-inline">
                        @csrf
                        <button type="submit" class="btn text-light py-2 px-4 ms-3" style="background-color: #4f5df9;">Logout</button>
                    </form>
                </div>
            </nav>
        ...
        <!-- Back to Top -->
        {{-- <a href="#" class="btn btn-lg btn-lg-square back-to-top" style="background-color:#6a75f3; color:aliceblue;"><i class="bi bi-arrow-up"></i></a> --}}
    </div>
